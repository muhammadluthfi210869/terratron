...
const WhatsAppCTA = () => {
    ...
    useEffect(() => {
        const handleScroll = () => {
            // Show FAB when scrolled past 80% of viewport height (past Hero)
    ...
    // Animation variants - Spring physics for premium feel
    const fabVariants = {
        hidden: {
            opacity: 0,
            scale: 0,
            ...
            {isVisible && (
                ...
                >
                    ...
                    >
                        ...
                        <span className="fab-pulse-ring fab-pulse-ring-delayed" />
