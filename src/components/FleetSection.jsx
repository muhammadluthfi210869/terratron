  ...
  return (
    <section className="titan-fleet-section" id="armada" ref={sectionRef}>
        ...
        >
          {units.map((unit, index) => {
            ...
            return (
              <article
                key={unit.id}
                id={`fleet-unit-card-${unit.id}`}
                className={`titan-card btn-cta ${isActive ? 'active' : ''}`}
              ...
              >
                ...
                <div className="titan-cta-zone">
                  ...
                  <a
                    href={`https://wa.me/6282260280392?text=Halo%20Admin,%20saya%20ingin%20tanya%20sewa%20unit%20${encodeURIComponent(unit.model)}`}
                    target="_blank"
                    rel="noopener noreferrer"
                    id={`fleet-unit-wa-${unit.id}`}
                    className="titan-direct-wa btn-cta"
      ...
      <div className="titan-cta-section">
        <Link to="/sewa-alat-berat" className="titan-btn titan-btn-primary btn-cta">
        ...
        <button className="titan-btn titan-btn-secondary btn-cta">
          <div className="btn-icon">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
