        ...
        >
            ...
            <Helmet>
                {selectedUnit ? (
                    ...
                    <>
                        <title>Harga Sewa Alat Berat 2026: SANY SY75, CAT 305, Komatsu PC75 — Jawa Barat</title>
                        <meta name="description" content="Daftar lengkap unit excavator sewa: SANY SY75, CAT 305.5E2, Komatsu PC75, Sumitomo SH75. Melayani Cikarang, Karawang, Bekasi dan seluruh Jawa Barat. Dokumen SILO & SIO lengkap." />
            ...
            {selectedUnit ? (
                    ...
                    <div className="unit-hero-identity-hud">
                        ...
                        <aside className="hud-side-panels">
                            ...
                            <div className="hud-action-center-standalone">
                                ...
                                >
                                    <span>SECURE THIS UNIT NOW</span>
                                </a>
                        ...
                        <div className="guarantee-grid">
                            ...
                            <div className="guarantee-item">
                                ...
                                <div className="guarantee-text">
                                    ...
                                    <p>Service car on-call sepanjang masa kontrak. Intervensi teknis area Jawa Barat instan.</p>
                                </div>
                            </div>
                            <div className="guarantee-item">
                                <div className="guarantee-icon">
                ...
                <>
                    ...
                    <section className="attachment-section container">
                        <SectionHeader idx="04" sub="// GRID-SCAN: ACTIVE" title="TECHNICAL_SPEC: ATTACHMENTS" />
                        <div className="attach-grid-tactical">
                            {attachmentData.map((item, idx) => (
                                <div key={item.id} className="attach-card-tactical">
                                    <div className="blueprint-bg" />
                                    <div className="attach-img-box-tactical">
                                        <img src={item.image} alt={item.name} />
                                        <div className="scan-line-anim" />
                                    </div>
                                    <div className="attach-info-tactical">
                                        <div className="attach-status-row">
                                            <span className="serial-no">SN: TR-ATT-0{idx + 1}</span>
                                            <div className="status-dot-active" />
                                        </div>
                                        <h4 className="attach-name-tactical">{item.name}</h4>
                                        <p className="attach-spec-preview">{item.spec}</p>
                                        <p className="attach-desc-text">{item.desc}</p>
                                    </div>
                                    <div className="corner-target-tl" />
                                    <div className="corner-target-br" />
                                </div>
                            ))}
                        </div>
                    </section>
                    ...
                    <section className="trust-section-lux container">
                        <SectionHeader idx="05" sub="// PROTOCOL: ENFORCED" title="RELIABILITY_ASSURANCE" />
                        <div className="assurance-stack-tactical">
                            {[
                                { label: '24/7', title: 'Mekanik Ready 24/7', desc: 'Service Car standby untuk intervensi teknis area Jawa Barat secara instan.', statusVal: 'OPERATIONAL', statusClass: 'operational' },
